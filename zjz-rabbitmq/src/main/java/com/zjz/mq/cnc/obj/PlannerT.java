...
public class PlannerT {
    ...
    private float[] previousUnitVec = new float[3];      // Unit vector of previous path line segment
    private float previousNominalSpeed;   // Nominal speed of previous path line segment
}
